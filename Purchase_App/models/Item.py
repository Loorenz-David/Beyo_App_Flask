...
#     multiplier = 1
#     if target.category and target.category == 'Seating':
#         print(target.properties,'the properties being checked')
...
#         if state.attrs.category.value == 'Seating':
...
# movving this logic to python side as it was not working properly in some cases
